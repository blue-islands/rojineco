...
window.onload = function(){
	...
	function onReadyFonts(){
		...
		let text = fontLoader.createText("ROJINE.CO!!", font, 4, 0, 14, -5);
		rootGroup.add(text);
	}
